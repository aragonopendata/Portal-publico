...
<%@ page import="es.aragon.base.category_related_sections.portlet.configuration.AragonCategoryRelatedSectionsPortletConfiguration" %>
<%@ page import="java.util.List" %>

<%
AragonCategoryRelatedSectionsPortletConfiguration configuration = (AragonCategoryRelatedSectionsPortletConfiguration) GetterUtil.getObject(renderRequest.getAttribute(AragonCategoryRelatedSectionsPortletConfiguration.class.getName()));
String presentFilters = portletPreferences.getValue("presentFilters", String.valueOf(configuration.presentFilters()));
String documentFilters = portletPreferences.getValue("documentFilters", String.valueOf(configuration.documentFilters()));
...
<liferay-frontend:edit-form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<liferay-frontend:edit-form-body>
		<liferay-frontend:fieldset-group>
			...
			<%-- <liferay-asset:asset-categories-selector hiddenInput="documentFilters" groupIds="<%= new long[] {groupId} %>" categoryIds="<%= documentFilters %>" className="<%= AssetEntry.class.getName() %>" /> --%>
		</liferay-frontend:fieldset-group>
	</liferay-frontend:edit-form-body>
