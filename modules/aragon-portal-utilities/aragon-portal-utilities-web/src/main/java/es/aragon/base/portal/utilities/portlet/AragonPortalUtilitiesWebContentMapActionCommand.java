...
@Component(
	    ...
	    property = {
	        ...
	        "mvc.command.name=" + AragonPortalUtilitiesPortletKeys.ROUTE_WEB_CONTENT
	    },
	    service = MVCActionCommand.class
	)
public class AragonPortalUtilitiesWebContentMapActionCommand extends BaseMVCActionCommand {
    ...
    protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		long dlFolderId = AragonPortalUtilitiesCommonUtils.fetchFolder(AragonPortalUtilitiesCommonUtils.WEB_CONTENT_FOLDER_PATH, themeDisplay.getScopeGroupId()).getFolderId();
		...
		QueuedProcessLocalServiceUtil.addQueuedProcess(themeDisplay.getScopeGroupId(), themeDisplay.getCompanyId(), 
				themeDisplay.getUser(), "WebContentMapBuild", jsonObject);
		
		String subject = "Solicitud generación mapa web de contenidos";
		String body = "Tu mapa web de contenidos webs será generado dentro de poco.\nRecibirás una notificación en el correo cuando este listo.";
