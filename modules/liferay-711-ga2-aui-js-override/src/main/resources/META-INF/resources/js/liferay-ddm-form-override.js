		...
		var ImageField = A.Component.create(
			{
				...
				prototype: {
					...
					getDocumentLibrarySelectorURL: function() {
						...
						return instance.getDocumentLibraryURL('com.liferay.item.selector.criteria.image.criterion.ImageItemSelectorCriterion,com.liferay.journal.item.selector.criterion.JournalItemSelectorCriterion');
					},
