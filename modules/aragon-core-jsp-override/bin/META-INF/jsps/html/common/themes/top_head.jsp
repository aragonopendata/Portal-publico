...
if (!themeDisplay.isSignedIn() && layout.isPublicLayout()) {
	...
	//Inicio-- Insercion código para arreglar etiqueta canonical en algunos contenidos y en el buscador
	if(completeURL != null && !completeURL.equals("") && completeURL.contains("/-/")){
	 	String[] canonicalURLArray = completeURL.split("[?]");
	 	canonicalURL = canonicalURLArray[0];	 	
