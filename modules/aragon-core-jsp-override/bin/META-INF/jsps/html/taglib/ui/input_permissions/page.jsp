...
<c:choose>
	...
	<c:when test="<%= modelName != null %>">
		...
		//-------------------------------------------------------------------------
		//Por defecto se debe mostrar la opción Guest para la selección de permisos
		...
		String inputPermissionsViewRole = ParamUtil.getString(request, "inputPermissionsViewRole", RoleConstants.GUEST);
		//-------------------------------------------------------------------------
		%>
