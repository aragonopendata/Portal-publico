...
package es.aragon.base.content_ratings.service.persistence.impl;
...
import es.aragon.base.content_ratings.model.impl.RatingImpl;
import es.aragon.base.content_ratings.model.impl.RatingModelImpl;
 ...
 * @see es.aragon.base.content_ratings.service.persistence.RatingUtil
 * @generated
 */
@ProviderType
public class RatingPersistenceImpl extends BasePersistenceImpl<Rating>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			RatingModelImpl.FINDER_CACHE_ENABLED, RatingImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			RatingModelImpl.FINDER_CACHE_ENABLED, RatingImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			RatingModelImpl.UUID_COLUMN_BITMASK |
			RatingModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			RatingModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Rating> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Rating> findByUuid(String uuid, int start, int end) {
	...
	public List<Rating> findByUuid(String uuid, int start, int end,
		...
		if (retrieveFromCache) {
			list = (List<Rating>)finderCache.getResult(finderPath, finderArgs,
					this);

			if ((list != null) && !list.isEmpty()) {
				for (Rating rating : list) {
					if (!Objects.equals(uuid, rating.getUuid())) {
						list = null;
	...
	public Rating findByUuid_First(String uuid,
		...
		Rating rating = fetchByUuid_First(uuid, orderByComparator);
	...
	public Rating fetchByUuid_First(String uuid,
		OrderByComparator<Rating> orderByComparator) {
		List<Rating> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Rating findByUuid_Last(String uuid,
		OrderByComparator<Rating> orderByComparator)
		throws NoSuchRatingException {
		Rating rating = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Rating fetchByUuid_Last(String uuid,
		...
		List<Rating> list = findByUuid(uuid, count - 1, count, orderByComparator);
	...
	public Rating[] findByUuid_PrevAndNext(long ratingId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, rating, uuid,
					orderByComparator, true);

			array[1] = rating;

			array[2] = getByUuid_PrevAndNext(session, rating, uuid,
	...
	protected Rating getByUuid_PrevAndNext(Session session, Rating rating,
		String uuid, OrderByComparator<Rating> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid(String uuid) {
		for (Rating rating : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "rating.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "rating.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(rating.uuid IS NULL OR rating.uuid = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			RatingModelImpl.FINDER_CACHE_ENABLED, RatingImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			...
			RatingModelImpl.UUID_COLUMN_BITMASK |
			RatingModelImpl.COMPANYID_COLUMN_BITMASK |
			RatingModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			RatingModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Rating> findByUuid_C(String uuid, long companyId) {
	 ...
	 */
	@Override
	public List<Rating> findByUuid_C(String uuid, long companyId, int start,
		int end) {
	...
	@Override
	public List<Rating> findByUuid_C(String uuid, long companyId, int start,
		int end, OrderByComparator<Rating> orderByComparator) {
	...
	public Rating findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<Rating> orderByComparator)
		throws NoSuchRatingException {
		Rating rating = fetchByUuid_C_First(uuid, companyId, orderByComparator);
	...
	public Rating fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<Rating> orderByComparator) {
		List<Rating> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	...
	public Rating findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<Rating> orderByComparator)
		throws NoSuchRatingException {
		Rating rating = fetchByUuid_C_Last(uuid, companyId, orderByComparator);
	...
	public Rating fetchByUuid_C_Last(String uuid, long companyId,
		...
		List<Rating> list = findByUuid_C(uuid, companyId, count - 1, count,
				orderByComparator);
	...
	public Rating[] findByUuid_C_PrevAndNext(long ratingId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, rating, uuid,
					companyId, orderByComparator, true);

			array[1] = rating;

			array[2] = getByUuid_C_PrevAndNext(session, rating, uuid,
	...
	protected Rating getByUuid_C_PrevAndNext(Session session, Rating rating,
		String uuid, long companyId,
		OrderByComparator<Rating> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (Rating rating : findByUuid_C(uuid, companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(rating);
		}
	}
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "rating.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "rating.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(rating.uuid IS NULL OR rating.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "rating.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CLASSNAMEIDCLASSPK =
		new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			...
			RatingModelImpl.CLASSNAMEID_COLUMN_BITMASK |
			RatingModelImpl.CLASSPK_COLUMN_BITMASK |
			RatingModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CLASSNAMEIDCLASSPK = new FinderPath(RatingModelImpl.ENTITY_CACHE_ENABLED,
			RatingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public List<Rating> findByClassNameIdClassPK(long classNameId, long classPK) {
	...
	public List<Rating> findByClassNameIdClassPK(long classNameId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Rating rating : list) {
					if ((classNameId != rating.getClassNameId()) ||
							(classPK != rating.getClassPK())) {
						list = null;
	...
	public Rating findByClassNameIdClassPK_First(long classNameId,
		...
		throws NoSuchRatingException {
		Rating rating = fetchByClassNameIdClassPK_First(classNameId, classPK,
				orderByComparator);
	...
	public Rating fetchByClassNameIdClassPK_First(long classNameId,
		long classPK, OrderByComparator<Rating> orderByComparator) {
		List<Rating> list = findByClassNameIdClassPK(classNameId, classPK, 0,
				1, orderByComparator);
	...
	public Rating findByClassNameIdClassPK_Last(long classNameId, long classPK,
		OrderByComparator<Rating> orderByComparator)
		throws NoSuchRatingException {
		Rating rating = fetchByClassNameIdClassPK_Last(classNameId, classPK,
				orderByComparator);
	...
	public Rating fetchByClassNameIdClassPK_Last(long classNameId,
		...
		List<Rating> list = findByClassNameIdClassPK(classNameId, classPK,
	...
	public Rating[] findByClassNameIdClassPK_PrevAndNext(long ratingId,
		...
		try {
			...
			array[0] = getByClassNameIdClassPK_PrevAndNext(session, rating,
					classNameId, classPK, orderByComparator, true);

			array[1] = rating;

			array[2] = getByClassNameIdClassPK_PrevAndNext(session, rating,
	...
	protected Rating getByClassNameIdClassPK_PrevAndNext(Session session,
		Rating rating, long classNameId, long classPK,
		OrderByComparator<Rating> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByClassNameIdClassPK(long classNameId, long classPK) {
		for (Rating rating : findByClassNameIdClassPK(classNameId, classPK,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(rating);
		}
	}
	...
	private static final String _FINDER_COLUMN_CLASSNAMEIDCLASSPK_CLASSNAMEID_2 = "rating.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_CLASSNAMEIDCLASSPK_CLASSPK_2 = "rating.classPK = ?";
	...
	public void cacheResult(Rating rating) {
		entityCache.putResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void cacheResult(List<Rating> ratings) {
		for (Rating rating : ratings) {
			if (entityCache.getResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
						RatingImpl.class, rating.getPrimaryKey()) == null) {
				cacheResult(rating);
			}
			else {
				rating.resetOriginalValues();
	...
	public void clearCache() {
		entityCache.clearCache(RatingImpl.class);
	...
	public void clearCache(Rating rating) {
		entityCache.removeResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
	...
	public Rating create(long ratingId) {
		...
		rating.setCompanyId(companyProvider.getCompanyId());
	 ...
	 */
	@Override
	public Rating remove(Serializable primaryKey) throws NoSuchRatingException {
		Session session = null;
	...
	@Override
	protected Rating removeImpl(Rating rating) {
		Session session = null;
	...
	public Rating updateImpl(Rating rating) {
		...
		if (!(rating instanceof RatingModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(rating.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(rating);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in rating proxy " +
					invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Rating implementation " +
				rating.getClass());
		}

		RatingModelImpl ratingModelImpl = (RatingModelImpl)rating;

		if (Validator.isNull(rating.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		try {
			...
			if (rating.isNew()) {
				...
				rating = (Rating)session.merge(rating);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (!RatingModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
			Object[] args = new Object[] { ratingModelImpl.getUuid() };
			...
			args = new Object[] {
					ratingModelImpl.getUuid(), ratingModelImpl.getCompanyId()
				};
			...
			args = new Object[] {
					ratingModelImpl.getClassNameId(),
					ratingModelImpl.getClassPK()
				};
			...
			if ((ratingModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { ratingModelImpl.getOriginalUuid() };

				finderCache.removeResult(FINDER_PATH_COUNT_BY_UUID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID,
					args);

				args = new Object[] { ratingModelImpl.getUuid() };
			...
			if ((ratingModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						ratingModelImpl.getOriginalUuid(),
						ratingModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] {
						ratingModelImpl.getUuid(),
						ratingModelImpl.getCompanyId()
					};
			...
			if ((ratingModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						ratingModelImpl.getOriginalClassNameId(),
						ratingModelImpl.getOriginalClassPK()
					};
		...
		entityCache.putResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
			RatingImpl.class, rating.getPrimaryKey(), rating, false);
	...
	/**
	 * Returns the rating with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the rating
	 * @return the rating
	 * @throws NoSuchRatingException if a rating with the primary key could not be found
	...
	public Rating fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (rating == null) {
			...
			try {
				...
				if (rating != null) {
					...
					entityCache.putResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
						RatingImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception e) {
				entityCache.removeResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
	...
	@Override
	public Map<Serializable, Rating> fetchByPrimaryKeys(
		Set<Serializable> primaryKeys) {
		if (primaryKeys.isEmpty()) {
			return Collections.emptyMap();
		}

		Map<Serializable, Rating> map = new HashMap<Serializable, Rating>();
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (Rating)serializable);
				}
			}
		}
		...
		query.append(_SQL_SELECT_RATING_WHERE_PKS_IN);
		...
		try {
			...
			for (Rating rating : (List<Rating>)q.list()) {
				map.put(rating.getPrimaryKeyObj(), rating);

				cacheResult(rating);

				uncachedPrimaryKeys.remove(rating.getPrimaryKeyObj());
			}
	...
	protected Map<String, Integer> getTableColumnsMap() {
		return RatingModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	public void destroy() {
		entityCache.removeCache(RatingImpl.class.getName());
	...
	private static final String _SQL_SELECT_RATING_WHERE_PKS_IN = "SELECT rating FROM Rating rating WHERE ratingId IN (";
	...
	private static final Log _log = LogFactoryUtil.getLog(RatingPersistenceImpl.class);
