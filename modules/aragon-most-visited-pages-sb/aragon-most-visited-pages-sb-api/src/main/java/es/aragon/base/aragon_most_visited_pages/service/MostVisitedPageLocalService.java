...
/**
 * Provides the local service interface for MostVisitedPage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MostVisitedPageLocalServiceUtil
...
public interface MostVisitedPageLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MostVisitedPageLocalServiceUtil} to access the most visited page local service. Add custom service methods to {@link es.aragon.base.aragon_most_visited_pages.service.impl.MostVisitedPageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MostVisitedPage addMostVisitedPage(MostVisitedPage mostVisitedPage);
	...
	*/
	...
	public MostVisitedPage createMostVisitedPage(long mostVisitedPageId);
	...
	*/
	...
	public MostVisitedPage deleteMostVisitedPage(long mostVisitedPageId)
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MostVisitedPage deleteMostVisitedPage(
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MostVisitedPage fetchMostVisitedPage(long mostVisitedPageId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MostVisitedPage getMostVisitedPage(long mostVisitedPageId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MostVisitedPage> getMostVisitedPages(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MostVisitedPage updateMostVisitedPage(
		MostVisitedPage mostVisitedPage);
}