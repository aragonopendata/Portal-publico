...
/**
 * Provides the local service interface for ContentMetadata. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContentMetadataLocalServiceUtil
...
public interface ContentMetadataLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContentMetadataLocalServiceUtil} to access the content metadata local service. Add custom service methods to {@link es.aragon.base.migration.service.impl.ContentMetadataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ContentMetadata addContentMetadata(ContentMetadata contentMetadata);

	public ContentMetadata addContentMetadata(long contentId,
		String primaryBody, String primaryImage, String primaryVideo,
		String secondaryBody, String imagesGalleryTitle,
	...
	*/
	...
	public ContentMetadata createContentMetadata(long contentMetadataId);
	...
	*/
	...
	public ContentMetadata deleteContentMetadata(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ContentMetadata deleteContentMetadata(long contentMetadataId)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContentMetadata fetchContentMetadata(long contentMetadataId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ContentMetadata> getContentMetadatas(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ContentMetadata updateContentMetadata(
		ContentMetadata contentMetadata);
}