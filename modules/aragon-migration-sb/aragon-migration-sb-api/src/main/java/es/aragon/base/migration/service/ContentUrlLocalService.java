...
/**
 * Provides the local service interface for ContentUrl. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContentUrlLocalServiceUtil
...
public interface ContentUrlLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContentUrlLocalServiceUtil} to access the content url local service. Add custom service methods to {@link es.aragon.base.migration.service.impl.ContentUrlLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ContentUrl addContentUrl(ContentUrl contentUrl);
	...
	*/
	...
	public ContentUrl createContentUrl(long contentUrlId);
	...
	*/
	...
	public ContentUrl deleteContentUrl(ContentUrl contentUrl);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ContentUrl deleteContentUrl(long contentUrlId)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContentUrl fetchContentUrl(long contentUrlId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContentUrl getContentUrl(long contentUrlId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ContentUrl> getContentUrls(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ContentUrl updateContentUrl(ContentUrl contentUrl);
}