...
/**
 * Provides the local service interface for ContentImage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContentImageLocalServiceUtil
...
public interface ContentImageLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContentImageLocalServiceUtil} to access the content image local service. Add custom service methods to {@link es.aragon.base.migration.service.impl.ContentImageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
