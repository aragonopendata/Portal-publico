...
/**
 * The base model interface for the CustomCategoryProperty service. Represents a row in the &quot;EAB_CCP_CustomCategoryProperty&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link es.aragon.base.categories_custom_properties.model.impl.CustomCategoryPropertyModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link es.aragon.base.categories_custom_properties.model.impl.CustomCategoryPropertyImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface CustomCategoryPropertyModel extends BaseModel<CustomCategoryProperty>,
	GroupedModel, ShardedModel, StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a custom category property model instance should use the {@link CustomCategoryProperty} interface instead.
	 */
