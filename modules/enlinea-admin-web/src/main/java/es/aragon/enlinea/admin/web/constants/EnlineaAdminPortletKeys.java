package es.aragon.enlinea.admin.web.constants;

/**
 * @author Asier Guillo
 */
public class EnlineaAdminPortletKeys {
	
	private EnlineaAdminPortletKeys() {}

	public static final String ENLINEA_ADMIN_WEB_PORTLET = "es_aragon_enlinea_admin_web_portlet_EnlineaAdminPortlet";
