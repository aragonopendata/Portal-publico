...
<#assign enlineaLastProcedures = freemarkerUtilities.getLastProcedures()/>
	...
	<ul class="container footer__policies__listado">
       ...
       <li class="logo-eu link hidden-sm hidden-sm hidden-md hidden-lg">
       	    <a href="http://www.aragon.es/Fondos_Europeos" class="european-flag" title="Más información sobre los Fondos Estructurales y de Inversión Europeos (Fondos EIE)" target="_blank">
	            <img class="image" src="${themeDisplay.getPathThemeImages()}/dga/flag_europe.svg" alt="">
				<p>
					<strong><@liferay.language key="aragon.ue-feder"/></strong>
				</p>
				<p class="claim">
					<span>Fondo Europeo</span><span>de Desarrollo Regional</span>
				</p>
...
<div class="footer__links">
	<ul class="container footer__links__list">
		...
		<#if layoutLocalService.fetchLayoutByFriendlyURL(themeDisplay.getScopeGroupId(), false, "/temas")??>
			...
			<#if childLayoutsLinksMap?? && childLayoutsLinksMap?has_content>
				<li class="col-xs-12 col-sm-12 col-md-3">			
					<div>
						<a class="title" data-toggle="collapse" href="#footer-links-temas" role="button" aria-expanded="true" aria-controls="footer-links-temas" tabindex="-1">
							<span class="oculto">(Enlaces a) </span>Temas
						</a>
					</div>
					<ul class="sec-list collapse show" id="footer-links-temas">
		...
		<#if contenido.columna.getSiblings()?has_content> 
			<#list contenido.columna.getSiblings() as curColumna> 
				<li class="col-xs-12 col-sm-12 col-md-${curColumna.claseColumna.getData()}">			
					<div>
						<a class="title" data-toggle="collapse" href="#footer-links-${curColumna?index}" role="button" aria-expanded="true" aria-controls="footer-links-${curColumna?index}" tabindex="-1"><span class="oculto">(Enlaces a) </span>${curColumna.getData()}</a>
					</div>
					<ul class="sec-list collapse show" id="footer-links-${curColumna?index}">
		...
		<#if enlineaLastProcedures?has_content>
			<li class="col-xs-12 col-sm-12 col-md-3">			
				<div>
					<a class="title" data-toggle="collapse" href="#footer-links-enlinea-procedures" role="button" aria-expanded="true" aria-controls="footer-links-enlinea-procedures" tabindex="-1"><span class="oculto">(Enlaces a) </span><@liferay.language key="aragon.enlinea-procedures-title"/></a>
				</div>
				<ul class="sec-list collapse show" id="footer-links-enlinea-procedures">
...
<div class="footer__rrss-contact container">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			...
			<span>${pie.direccion.getData()} <#if pie.telefono?? && pie.telefono.getData()?has_content> - <abbr title="Teléfono">Tfno.</abbr> <a href="tel:+976714000">976 714 000</a></#if></span>
		</div>
		<a href="http://www.aragon.es/Fondos_Europeos" class="hidden-xs col-sm-3 european-flag" title="Más información sobre los Fondos Estructurales y de Inversión Europeos (Fondos EIE)">
			<img class="image" src="${themeDisplay.getPathThemeImages()}/dga/flag_europe.svg" alt="">
			<p>
				<strong><@liferay.language key="aragon.ue-feder"/></strong>
			</p>
			<p class="claim">
				...
				<span>de Desarrollo Regional</span>
			</p>
			<p class="sub-claim">"Construyendo Europa desde Aragón"</p>
        </a>	
	</div>
