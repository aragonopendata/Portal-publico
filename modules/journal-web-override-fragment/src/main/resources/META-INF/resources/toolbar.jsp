...
int totalSearchResults = journalWebOverrideFragmentUtil.getSearchContainer(request, liferayPortletRequest, liferayPortletResponse, liferayPortletResponse.createRenderURL(), true, false).getTotal();
