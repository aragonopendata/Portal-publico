...
SearchContainer articleSearchContainer = journalWebOverrideFragmentUtil.getSearchContainer(request, liferayPortletRequest, liferayPortletResponse, liferayPortletResponse.createRenderURL(), true, false);
