var MediaPlayer = function () {
	...
	return function (i, o) {
		...
		u.media = l(i, {
			...
			role: "slider",
			"title":s.currentTime || "current time",
			...
			role: "timer",
			"title":s.remainingTime || "remaining time",
		...
		function k() {
			h !== i.paused && (h = i.paused, l(u.play, {
				"title" : h ? s.play || "play" : s.pause || "pause",
		...
		function D() {
			...
			u.volumeMeter.style[n] = 100 * e + "%", l(u.mute, {
				"title" : t ? s.unmute || "unmute" : s.mute || "mute",
